...
public class MapaEditarDatos extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_editar_datos);
        ...
        conn =  new connection(getApplicationContext(), "db_mapa",null, 1 );
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.btnVerEnMapa){
            ...
            Intent mapsIntent = new Intent(MapaEditarDatos.this, MapsActivity.class);
